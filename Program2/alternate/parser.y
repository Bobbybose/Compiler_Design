 ...
 */
%token VAR NUMBER '+' '-' '*' '/' '(' ')' '=' '\n' IF ELSE WHILE FOR INT FLOAT CHAR ID INT_LIT FP_LIT CHAR_LIT STRING_LIT EQUAL_EQUAL NOT_EQUAL LESS_THAN LESS_THAN_OR_EQUAL GREATER_THAN GREATER_THAN_OR_EQUAL AND OR SEMICOLON OPEN_BRACE CLOSE_BRACE EMPTY_STRING
